...
Experiment_Name = '80_Bridge_250803'
n_iters = 100 # change for hyak
param_names = ['Density', 'U_0', 'r0', 'n', 'm']  # Extend or change as needed
target_mins = torch.tensor([0.00005, 0.1, 2.85, 1, 1], dtype=torch.float64) #hyak
target_maxs = torch.tensor([0.005, 150, 2.95, 30, 30], dtype=torch.float64) #hyak
