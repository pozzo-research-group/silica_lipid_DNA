...
def objective(Experiment_Name, iteration, Sample, param_names, *simulation_inputs):
    ...
    exp_data_scattering = np.load('Experimental_data/bridge_40.npy')[:-200, :]
...
Experiment_Name = '40_Bridge_250812'
n_iters = 100 # change for hyak
param_names = ['Density', 'U_0', 'r0', 'n', 'm']  # Extend or change as needed
target_mins = torch.tensor([0.00005, 0.1, 2.40, 1, 1], dtype=torch.float64) #hyak
target_maxs = torch.tensor([0.005, 150, 2.50, 30, 30], dtype=torch.float64) #hyak
